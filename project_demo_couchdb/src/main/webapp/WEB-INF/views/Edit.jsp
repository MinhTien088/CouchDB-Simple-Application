...
<body>
	...
	<form action="edit?id=${person.getId()}" method="post"
		class="form-container">
		<input type="hidden" name="ID" value="${person.getId()}">

		<div class="form-group">
			<label for="inputString">Name:</label> <input type="text"
				name="inputString" id="inputString" value="${person.getName()}"
				required>
		</div>
		...
		<div class="form-group">
			<label for="imageFile">Image (3x4):</label> <input type="file"
				name="imageFile" id="imageFile" accept="image/*"
				onchange="displayImage(this)">
		</div>

		<img id="selectedImage" src="${person.getImage()}"
			alt="Selected Image">
